            ...
            <div className="footer-container">
                ...
                <div className="footer-section social-media">
                    ...
                    <div className="social-links">
                        <a href="https://facebook.com/Infoduta-Computindo-Perkasa" className="social-link facebook" target="_blank" rel="noopener noreferrer">
                        ...
                        <a href="https://instagram.com/infodutacp_official" className="social-link instagram" target="_blank" rel="noopener noreferrer">
                            <div className="social-icon">
                                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                            ...
                            <div className="social-text">
                                ...
                                <span className="social-username">@infodutacp_official</span>
                            </div>
                        </a>
                        ...
                        <a href="https://youtube.com/@infodutacp_official" className="social-link youtube" target="_blank" rel="noopener noreferrer">
                            <div className="social-icon">
                                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                        ...
                        <a href="https://wa.me/6281234567890" className="social-link whatsapp" target="_blank" rel="noopener noreferrer">
                            <div className="social-icon">
                                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                            ...
                            <div className="social-text">
                                ...
                                <span className="social-username">+62 812-3456-7890</span>
                            </div>
                        </a>
                    </div>
                </div>
