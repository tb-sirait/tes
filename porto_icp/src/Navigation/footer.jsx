  ...
  return (
    <footer className="foot-footer">
      <div className="foot-container">
        <div className="foot-section foot-company-info">
          <img
            className="foot-icp-image"
            src={logoIcp}
            title="logo_icp"
            style={{ width: "66px", height: "60px" }}
          />
          <p className="foot-company-description">
          ...
          <div className="foot-maps-container">
            <iframe
              ...
              title="Lokasi PT Infoduta Computindo Perkasa"
            ></iframe>
          </div>

          <div className="foot-company-address">
            <h4>Alamat Kantor</h4>
            <p>
              <strong>HR Building 1 Wahid Hasyim Lt. G2</strong>
              <br />
        ...
        {/* Navigation Section */}
        <div className="foot-section foot-navigation">
          <h4 className="foot-section-title">Navigasi</h4>
        ...
        {/* Services Section */}
        <div className="foot-section foot-services">
          <h4 className="foot-section-title">Layanan Kami</h4>
          <ul className="foot-links">
            <li>
              <a href="/layanan">Penjualan Produk IT</a>
            </li>
            <li>
              <a href="/layanan">Penyewaan Produk IT</a>
            </li>
            <li>
              <a href="/produk">Produk yang tersedia</a>
            </li>
            <li>
              <a href="/layanan">IT Consulting</a>
            </li>
          </ul>
        </div>

        {/* Social Media Section */}
        <div className="foot-section foot-social-media">
          <h4 className="foot-section-title">Ikuti Kami</h4>
          <div className="foot-social-links">
            <a
              href="https://www.facebook.com/komputermenteng/"
              className="foot-social-link foot-facebook"
              target="_blank"
            ...
            >
              ...
              <div className="foot-social-text">
                <span className="foot-social-name">Facebook</span>
            ...
            <a
              ...
              className="foot-social-link foot-instagram"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="foot-social-icon">
            ...
            <a
              href="https://linkedin.com/company/infoduta-computindo-perkasa"
              className="foot-social-link foot-linkedin"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="foot-social-icon">
              ...
              <div className="foot-social-text">
                <span className="foot-social-name">LinkedIn</span>
                <span className="foot-social-username">
                  Infoduta Computindo Perkasa
                </span>
              </div>
            ...
            <a
              ...
              className="foot-social-link foot-youtube"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="foot-social-icon">
              ...
              <div className="foot-social-text">
                <span className="foot-social-name">YouTube</span>
                <span className="foot-social-username">
                  Infoduta Computindo Perkasa
                </span>
              </div>
            ...
            <a
              ...
              className="foot-social-link foot-tiktok"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="foot-social-icon">
            ...
            <button
              ...
              className="foot-social-link foot-whatsapp"
            ...
            >
              ...
              <div className="foot-social-text">
                <span className="foot-social-name">WhatsApp</span>
                <span className="foot-social-username">
